...
using System.Web;
using fashionUtilityApplication;
...
public class NVPAPICaller
{
    ...
    public bool ShortcutExpressCheckout(string amt, ref string token, ref string retMsg)
    {
        ...
        using (fashionUtilityApplication.Logic.ShoppingCartActions myCartOrders = new fashionUtilityApplication.Logic.ShoppingCartActions())
        {
