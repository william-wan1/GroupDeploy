...
namespace fashionUtilityApplication
{
    public partial class ShoppingCart : System.Web.UI.Page
    {
        ...
        protected void PaypalCheckout(object sender, ImageClickEventArgs e)
        {
            SendCartDetails();
        ...
        protected void BraintreeCheckout(object sender, ImageClickEventArgs e)
        {
            SendCartDetails();
            Session["payment_method"] = "Braintree";
            Response.Redirect("Checkout/CheckoutStart.aspx");
        }
