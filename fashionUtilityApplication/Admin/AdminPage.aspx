<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AdminPage.aspx.cs" Inherits="fashionUtilityApplication.Admin.AdminPage" %>
    ...
    <div class="container authorization">
        ...
        <table>
            <tr>
                ...
                <td><asp:DropDownList ID="DropDownRemoveProduct" runat="server" ItemType="fashionUtilityApplication.Models.Product" 
